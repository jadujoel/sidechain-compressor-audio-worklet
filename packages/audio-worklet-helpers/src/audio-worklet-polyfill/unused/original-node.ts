...
//   const {outputChannelCount, numberOfInputs} = options
//   const processor = getProcessorsForContext(context)[name]
//   const outputChannels = outputChannelCount ? outputChannelCount[0] ?? 2 : 2
//   const inputChannels = numberOfInputs ?? 2
//   const me = context.createScriptProcessor(undefined, inputChannels, outputChannels) as unknown as mAudioWorkletNode
